...
public class WorldTagDictionary<T> implements ITagDictionary<T, World> {
    private final Map<World, Map<String, T>> tags = new HashMap<World, Map<String, T>>();

    public WorldTagDictionary() { }
    ...
    @Override
    public void load(Map tagMap, Map<UUID, Entity> entities) { //<String, Map<String, TaggedType>>
