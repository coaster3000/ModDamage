...
import com.ModDamage.Backend.Configuration.Parsing.EventDataProvider;
...
public abstract class EventInfo
{
	...
	public int getIndex(Class<?> cls, String name, boolean complain) {
		...
		if (complain && index == -1)
		{
			...
			ModDamageLogger.error("Unknown "+cls.getSimpleName()+" named '"+ name +"'" + (names.length() > 0? ", did you mean " + names + "?" : ""));
		}
		return index;
	}
