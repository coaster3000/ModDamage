	...
	protected static class RoutineFactory extends Routine.RoutineFactory
	{
		...
		public IRoutineBuilder getNew(Matcher matcher, ScriptLine scriptLine, EventInfo info)
		{
            ...
            else
            {
                ...
                {
                	ModDamageLogger.error("The entity '"+livingDP+"' doesn't have a natural opposite. Use .hurt.from.{entity}");
                    return null;
                }
            }
			...
			ModDamageLogger.info("Hurt "+livingDP + (matcher.group(2) != null? " from " + entityOtherDP : "") + " by " + hurt_amount);
