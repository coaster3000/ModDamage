	...
	protected static class RoutineFactory extends Routine.RoutineFactory
	{
		...
		public IRoutineBuilder getNew(Matcher matcher, ScriptLine scriptLine, EventInfo info)
		{
			...
			if (repeatName == null)
			{
				...
				if (repeatName == null)
				{
					ModDamageLogger.error("No repeat name?");
					return null;
				}
			...
			if (delay != null)
				ModDamageLogger.info("Start Repeat: on " + itDP + " named \""+repeatName+"\" delay " + delay + " count " + count);
			else
				ModDamageLogger.info("Stop Repeat: on " + itDP + " named \""+repeatName+"\"");
