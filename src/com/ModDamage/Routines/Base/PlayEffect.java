		...
		{ 
			...
			if (matcher.group(3) == null)
				...
				if (ndata == null)
				{
					...
					if (data == null)
					{
						ModDamageLogger.error("Bad extra data: \""+matcher.group(3)+"\" for " + effectType + " effect.");
						return null;
					}
				}
				else
			...
			if (matcher.group(4) != null)
			{
				...
				if (radius == null)
				{
					ModDamageLogger.error("Unable to match expression: \""+matcher.group(4)+"\"");
					return null;
				}
			}
			
			ModDamageLogger.info("PlayEffect: " + locDP + " " + effectType + " " + data + (radius != null? " " + radius : ""));
